    ...
    <div className={styles.about}>
      ...
      <Container>
        ...
        <p className={styles.talk}>
          ...
          transportation. Our mission is simple yet vital:<br></br> to make your
          bus travel easier, more efficient, and accessible, no matter where you
          are.
        </p>
        <div>
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              <p className={styles.talk}>
                ...
                visualize and plan your journey with ease. Each route is clearly
                classified and color-coded for quick identification, ensuring
                you can find the best route to your destination.
              </p>
            </li>
            <li>
              ...
              <p className={styles.talk}>
                Navigating to your bus station or stop has never been easier. We
                provide step-by-step directions from your current location to
                your chosen bus stop or station. Whether you're walking,
                driving, or cycling, our directions are tailored to suit your
                mode of travel, ensuring you reach your bus stop efficiently.
              </p>
            </li>
            <li>
              <p className={styles.listheader}>Real-Time Location Services:</p>
              <p className={styles.talk}>
            ...
            <li>
              ...
              <p className={styles.talk}>
                ...
                metropolitan areas or quieter suburban zones, our coverage spans
                across diverse landscapes, offering users access to a vast
                network of public transportation options.
              </p>
            </li>
          </ul>
        </div>
        <div>
          ...
          <p className={styles.talk}>
            At <span className={styles.logo}>NAZEL</span>, we believe in the power of seamless and
            stress-free travel. We're more than just a platform; we're a
            community of explorers, commuters, and everyday travelers, united in
            the pursuit of easier bus journeys. Join us today and embark on a
            smarter way to travel by bus!
          </p>
        </div>
      </Container>
    </div>
